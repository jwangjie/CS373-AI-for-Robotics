# -*- coding: utf-8 -*-
"""
Created on Thu Feb  8 20:24:49 2018
...
class plan:
    ...
    heuristic = [[9, 8, 7, 6, 5, 4],
                 ...
                 [5, 4, 3, 2, 1, 0]]
    """
    # heuristic h(x, y) <= distance to goal from x, y     
    ...
    def astar(self):
        ...
        while not found and not resign:
            ...
            if len(open) == 0:
                ...
                """
                sorting the array (sort() will sort the list in ascending order),
                then reversing the array with reverse() to make it descending (smallest value at end), and
                then removing the last value from the array by pop() and assigning it to next. This gives us the
                smallest value of g, and that is why it’s important that the g value was first in the triplet values
                in the open list.
                """
                open.sort()
                #open.reverse()
        ...
        while change >= tolerance:
            ...
            for i in range(1, len(self.path)-1):
                for j in range(len(self.path[0])):
                    ...
                    # why this is different with Lesson 15. quiz path smoothing 
                    # why the newpath[i][j] need to be updated two times
...
# which was convered in lesson 8 Particle Filters
