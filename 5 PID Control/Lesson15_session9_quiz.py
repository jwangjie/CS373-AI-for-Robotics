# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 18:31:16 2017
...
def run(param):
    ...
    speed = 1.0 # motion distance is equalto speed (we assume time = 1)
    N = 100 

    for i in range(N):
        corsstrack_error = myrobot.y
        steer = -param * corsstrack_error
        # the robot.move function need two input: steer and position. 
